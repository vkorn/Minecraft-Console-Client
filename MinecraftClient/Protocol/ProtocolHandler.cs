    ...
    public static class ProtocolHandler
    {
            ...
            IMinecraftComHandler Handler)
        {
            ...
            int[] supportedVersions_Protocol18 =
            {
                ...
                (int) ProtocolVersions.MC114Pre5, (int) ProtocolVersions.MC1142Pre4, (int) ProtocolVersions.MC1142,
                (int) ProtocolVersions.MC1143, (int) ProtocolVersions.MC1144,
            };
            ...
            if (MCVersion.Contains('.'))
            {
                switch (MCVersion.Split(' ')[0].Trim())
                {
                    ...
                    case "1.14 Pre-Release 5":
                        return (int) ProtocolVersions.MC114Pre5;
                    default:
                        return 0;
                }
            }
